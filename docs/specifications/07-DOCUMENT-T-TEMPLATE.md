...
├─ 1.2 North Star Metric Overview
├─ 1.3 Key Performance Indicators Summary
├─ 1.4 Current State Baseline
└─ 1.5 How to Use This Document

SECTION 2: MEASUREMENT FRAMEWORK (6-10 pages) ⭐
├─ 2.1 Measurement Philosophy
│   ├─ Principles (actionable over vanity, leading over lagging)
│   ├─ Metric Selection Criteria
│   └─ Measurement vs. Optimization Balance
│
├─ 2.2 Metric Hierarchy
│   ├─ North Star Metric (singular focus)
│   ├─ Primary KPIs (5-7 key metrics)
│   ├─ Secondary KPIs (supporting metrics)
│   └─ Health Metrics (foundational indicators)
│
...
SECTION 3: NORTH STAR METRIC (5-8 pages) ⭐
├─ 3.1 North Star Definition
│   ├─ Metric Name
│   ├─ Metric Definition (exactly what we measure)
│   ├─ Formula/Calculation Method
│   └─ Why This Metric (rationale)
│
├─ 3.2 North Star Rationale
│   ├─ Connection to Business Model
│   ├─ Connection to Customer Value
│   ├─ Why Not Revenue/Users/Other
│   └─ Cross-Functional Alignment
│
├─ 3.3 North Star Targets
│   ├─ Current Baseline
│   ├─ Short-Term Target (3-6 months)
│   ├─ Medium-Term Target (12 months)
│   ├─ Long-Term Target (24-36 months)
│   └─ Stretch Goal (aspirational)
│
└─ 3.4 North Star Drivers
    ├─ Input Metrics (what drives North Star)
    ├─ Driver Analysis (which inputs most impactful)
    └─ Optimization Priorities

SECTION 4: KPI TREE (8-12 pages) ⭐
├─ 4.1 KPI Tree Structure
│   └─ Visual hierarchy: North Star → Primary → Secondary → Health
│
├─ 4.2 Primary KPIs (5-7 metrics)
│   ├─ KPI 1
│   │   ├─ Metric Name & Definition
│   │   ├─ Why It Matters
│   │   ├─ Formula/Calculation
│   │   ├─ Current Baseline
│   │   ├─ Target (3/6/12 months)
...
│   ├─ KPI 4
│   ├─ KPI 5
│   └─ [up to 7 primary KPIs]
│
├─ 4.3 Secondary KPIs (10-15 metrics)
│   [Same structure as Primary, but less detail]
│
└─ 4.4 Health Metrics (Foundational)
    ├─ Metric 1: [e.g., "System Uptime"]
    ├─ Metric 2: [e.g., "Customer Satisfaction"]
    └─ [...]
...
│   ├─ Churn Rate
│   └─ Advocacy Rate (referrals, reviews)
│
└─ 5.4 Brand Equity
    ├─ Price Premium Ability
    ├─ Brand Valuation (financial)
    └─ Interbrand-Style Equity Score
...
│   ├─ Retention Curves (day 7, 30, 90, 365)
│   ├─ Churn Rate & Reasons
│   ├─ Cohort Analysis
│   └─ Reactivation Rate
│
...
│   └─ Revenue Growth Rate
│
└─ 6.5 Referral/Advocacy Metrics
    ├─ Referral Rate
    ├─ Viral Coefficient
    ├─ Net Promoter Score (NPS)
    └─ Review/Rating Volume & Sentiment

SECTION 7: CAMPAIGN & CONTENT METRICS (6-10 pages)
├─ 7.1 Campaign Performance Framework
│   ├─ Campaign Objectives Alignment
│   ├─ Campaign Measurement Standards
│   └─ Attribution Modeling
│
├─ 7.2 Awareness Campaign Metrics
│   ├─ Impressions & Reach
│   ├─ Brand Lift Studies
│   ├─ Share of Voice
│   └─ Earned Media Value
│
├─ 7.3 Consideration Campaign Metrics
│   ├─ Engagement Rate
│   ├─ Content Consumption (time, depth)
│   ├─ Lead Generation
│   └─ Intent Signals
│
├─ 7.4 Conversion Campaign Metrics
...
│   └─ Revenue Attribution
│
└─ 7.5 Content Performance
    ├─ Content Engagement Metrics
    ├─ Content Efficiency (ROI per piece)
    ├─ SEO Performance (rankings, traffic)
    └─ Social Performance (shares, saves, comments)

SECTION 8: CHANNEL METRICS (6-10 pages)
├─ 8.1 Digital Channels
│   ├─ Website Analytics
...
│   └─ SEO/SEM Metrics
│
├─ 8.2 Offline Channels (if applicable)
...
│   ├─ Customer Support Quality (CSAT, resolution time)
│   ├─ Product/Service Quality (NPS, defect rate)
...
SECTION 11: DASHBOARDS & REPORTING (8-12 pages) ⭐
...
│   ├─ Sales Dashboard (pipeline, revenue)
│   └─ Customer Success Dashboard (health scores)
│
├─ 11.2 Dashboard Design Principles
│   ├─ Visual Hierarchy
│   ├─ Color Coding (red/yellow/green status)
│   ├─ Actionability (every metric → action)
│   └─ Accessibility (mobile-friendly)
│
├─ 11.3 Reporting Cadence
│   ├─ Daily Reports (what & who)
│   ├─ Weekly Reports (what & who)
│   ├─ Monthly Reports (comprehensive review)
│   ├─ Quarterly Reports (board-level)
│   └─ Annual Reports (strategic review)
│
...
│   ├─ First-Party Data (owned channels)
│   ├─ Third-Party Data (partners, purchased)
│   ├─ Tracking Implementation (tags, pixels, SDKs)
│   └─ Data Quality & Governance
│
├─ 12.2 Analytics Stack
│   ├─ Core Analytics Platform (e.g., GA4, Amplitude)
│   ├─ Business Intelligence Tools (e.g., Tableau, Looker)
│   ├─ Marketing Analytics (e.g., HubSpot, Marketo)
│   ├─ Social Listening (e.g., Brandwatch, Sprinklr)
...
│   ├─ Test Prioritization (PIE: Potential, Importance, Ease)
│   ├─ Test Design Methodology
│   ├─ Sample Size Calculations
│   └─ Statistical Significance Standards
│
├─ 13.2 Optimization Process
│   ├─ Hypothesis Development
│   ├─ Test Execution
│   ├─ Analysis & Learning
│   └─ Implementation
│
└─ 13.3 Growth Experiments
...
├─ A. Complete Metric Definitions Glossary
├─ B. Calculation Formulas Reference
├─ C. Dashboard Mockups
├─ D. Report Templates
├─ E. Analytics Tool Documentation
├─ F. Data Tracking Specifications
└─ G. Industry Benchmark Data
```
...
north_star_metric:
  ...
  formula_calculation:
    formula: "Nights Booked = Σ (Check-out Date - Check-in Date) for all
    ...
    example: "User books 3-night stay in Paris → +3 nights booked
              User books 7-night stay in Tokyo → +7 nights booked
  ...
  why_this_metric: |
    ...
    It's a leading indicator of revenue (more nights → more fees) but better
    ...
    Every team can contribute: Marketing (more awareness → bookings), Product
    (better search/trust → bookings), Pricing (optimal prices → bookings),
    Supply (more listings → bookings), Customer Service (solve issues → bookings).
  ...
  nsm_drivers:
    - driver_1:
        ...
        relationship: "New guests → more nights booked (if they activate)"
    ...
    - driver_2:
        ...
        relationship: "Guests who book again → more total nights"
    ...
    - driver_3:
        ...
        relationship: "Longer stays → more nights per transaction"
    ...
    - driver_4:
        ...
        relationship: "More unique listings → more choice → more bookings"
        current_state: "7M active listings"
        improvement_potential: "Expand to 10M through host acquisition, reactivation"

    - driver_5:
        name: "Conversion Rate (searches → bookings)"
        relationship: "Higher conversion → more nights from same traffic"
...
primary_kpi_2:
  ...
  relationship_to_nsm: "Activated users retain 5x better → drive ARR (NSM)"
  ...
  formula:
    calculation: "Activation Rate = (Users who hit activation criteria
                  within 7 days / Total new signups) × 100"
    data_sources: "Product analytics (Amplitude), user event tracking"
    example: "Week of Jan 1-7: 500 signups, 175 activated → 35% activation rate"
...
dashboard_executive:
  ...
  key_metrics_displayed:
    - metric_1:
        ...
        alert_status: "Green if on-track (≥95% of target), Yellow if 80-95%, Red if <80%"

    - metric_2:
        name: "Monthly Revenue"
        visualization: "Number card + YoY comparison"
        position: "Top-center"
        alert_status: "Green ≥100% target, Yellow 90-100%, Red <90%"
    ...
    - metric_4:
        ...
        alert_status: "Green ≥3.0, Yellow 2.0-3.0, Red <2.0"

    - metric_5:
        name: "Net Promoter Score"
        visualization: "Number card + trend arrow"
        position: "Middle-center"
        alert_status: "Green ≥50, Yellow 30-50, Red <30"

    - metric_6:
        name: "Churn Rate"
        visualization: "Line chart with benchmark line"
        position: "Middle-right"
        alert_status: "Green ≤3%, Yellow 3-5%, Red >5%"
  ...
  drill_down_capability:
    - "Click any metric → detailed dashboard for that metric"
    - "Click time period → granular daily/weekly view"
    - "Click geography → country-level breakdowns"
...
ab_testing_framework:
  ...
  test_prioritization_framework:
    method: "PIE Score (Potential × Importance × Ease)"
...
- Brand purpose → brand health metrics
- Values → values-in-action tracking

**From Document V (Valeur):**
- Value proposition → value delivery metrics
- Target personas → segmented performance

**From Document E (Engagement):**
- Campaign objectives → campaign metrics
- Touchpoints → channel metrics
...
**Too Many Metrics:**
- ❌ Tracking 100+ metrics (overwhelming, unfocused)
- ✅ North Star + 5-7 primary KPIs (clarity, alignment)

**Vanity Metrics:**
- ❌ "10M social media impressions!" (meaningless without context)
- ✅ "500 leads from social (10% conversion to customer)"

**No Baselines:**
- ❌ "We want to increase NPS" (from what? to what?)
- ✅ "Increase NPS from 42 to 55 in 12 months"

**Lagging Only:**
- ❌ Revenue as only metric (know too late to fix)
- ✅ Leading indicators (pipeline, activation) + lagging (revenue)

**Not Actionable:**
- ❌ "Brand awareness declined" (so what do we do?)
- ✅ "Unaided awareness down 5pp → increase content marketing 20%, test brand campaign"
...
**STATUS:** Document T template complete ✓
