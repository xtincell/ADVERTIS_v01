  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6 p-4 md:p-6">
      <PageHeader
        ...
        description="Vue consolidée des données marché de toutes vos stratégies"
        backHref="/impulsion"
      ...
      {strategies.length === 0 ? (
        <EmptyState
          icon={Globe}
          title="Aucune stratégie trouvée"
          description="Créez une fiche de marque pour commencer."
          action={{ label: "Nouvelle Fiche", href: "/impulsion/new" }}
        />
      ) : (
        <>
          {/* Tab navigation */}
                        ...
                        <CardContent className="p-4">
                          ...
                          <div className="mt-1 flex flex-wrap gap-1">
                            {entries.map((e) => (
                              <Link
                                key={e.strategyId}
                                href={`/impulsion/brand/${e.strategyId}`}
            ...
            {activeTab === "opportunities" && (
              <div className="space-y-4">
                {opportunities.length === 0 ? (
                  <EmptyState
                    icon={Calendar}
                    title="Aucune opportunité identifiée"
                    compact
                  />
                ) : (
                    ...
                    {opportunities.map((opp) => (
                      ...
                      >
                        ...
                        <Button variant="outline" size="sm" className="shrink-0" asChild>
                          <Link href={`/impulsion/brand/${opp.strategy.id}`} className="text-[10px]">
                              ...
                              {ss.brandIds
                                ? ss.brands.map((brand, bi) => (
                                    <span key={bi}>
                                      {bi > 0 && ", "}
                                      <Link
                                        href={`/impulsion/brand/${ss.brandIds[bi]}`}
