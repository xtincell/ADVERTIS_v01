...
const PILLAR_FIELDS: Record<string, FieldDef[]> = {
  ...
  V: [
    { path: "produitsCatalogue", label: "Catalogue Produits", type: "array", minLength: 1 },
    { path: "productLadder", label: "Product Ladder", type: "array", minLength: 2 },
    { path: "valeurMarqueTangible", label: "Valeur marque tangible", type: "array", minLength: 1 },
    { path: "valeurMarqueIntangible", label: "Valeur marque intangible", type: "array", minLength: 1 },
    { path: "valeurClientTangible", label: "Valeur client tangible", type: "array", minLength: 1 },
    { path: "valeurClientIntangible", label: "Valeur client intangible", type: "array", minLength: 1 },
    { path: "coutMarqueTangible", label: "Cout marque tangible", type: "array", minLength: 1 },
    { path: "coutMarqueIntangible", label: "Cout marque intangible", type: "array", minLength: 1 },
    { path: "coutClientTangible", label: "Cout client tangible", type: "array", minLength: 1 },
    { path: "coutClientIntangible", label: "Cout client intangible", type: "array", minLength: 1 },
    { path: "cac", label: "CAC", type: "string" },
    { path: "ltv", label: "LTV", type: "string" },
    { path: "ltvCacRatio", label: "Ratio LTV/CAC", type: "string" },
    { path: "pointMort", label: "Point mort", type: "string" },
    { path: "marges", label: "Marges", type: "string" },
  ],
  E: [
